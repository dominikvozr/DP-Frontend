			...
			<div class="bg-white px-6 pt-24 pb-12 sm:pt-32 lg:px-8">
				<div class="mx-auto max-w-2xl text-center">
					...
					<button
						type="button"
						ref={copyableRef}
						data-link={`git clone http://${dataResource.value.user.gitea.accessToken.sha1}@bawix.xyz:81/gitea/${dataResource.value.user.gitea.username}/${dataResource.value.test.slug}.git`}
