          ...
          <div class="py-2 min-w-0 border-b border-indigo-800 bg-indigo-600">
            <nav class="flex justify-between w-full px-4 sm:px-6 lg:px-8" aria-label="Breadcrumb">
              <div class="flex">
                ...
                <h1 class="truncate self-center ml-5 text-2xl text-center font-bold text-indigo-200">{state.exam.name}</h1>
              </div>
              <div class="flex">
                <a class="self-center ml-3 p-2 bg-white rounded-full"
                  href="#"
                  ...
                  onClick$={() => {
                   nav.path = "/professor/exam/update" + state.exam._id
                    ...
                    {/* pencil sqare */}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="rgb(79 70 229)" class="w-6 h-6">
                  ...
                  <a class="self-center ml-3 p-2 bg-white rounded-full"
                    ...
                    {/* trash */}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="rgb(220 38 38)" class="w-6 h-6">
