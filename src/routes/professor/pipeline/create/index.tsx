          ...
          <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
              <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">Túto pipelinu bude možné použiť pri vytváraní testu. Musí to byť Jenkins pipeline súbor (jenkinsfile). Definujte ju podľa používaného jazyka a buildovacieho nástroja</p>
              </div>
            </div>
                  ...
                  <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                      <div class="col-span-6 sm:col-span-3">
                        <label for="name" class="block text-sm font-medium text-gray-700">Názov pipeliny</label>
                      ...
                      <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                          <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">
                            ...
                            <input id="file-upload" name="pipeline"
                              onChange$={(ev: any) => {
