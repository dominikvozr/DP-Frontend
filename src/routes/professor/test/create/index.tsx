                  ...
                  <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                      <div class="flex space-x-3 sm:pt-5">
                        <label htmlFor="start-date" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                          Začiatok
                        </label>
                      ...
                      <div class="flex space-x-3 sm:pt-5">
                        <label htmlFor="end-date" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                          Koniec
                        </label>
                        <div class="mt-1 sm:col-span-2 sm:mt-0 flex-1">
                          <input
                              ...
                              <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">
                                ...
                                <input id="file-upload" name="file-upload"
                                  onChange$={(ev: any) => {
                                    ...
                                    state.project = ev.target.files[0]
                                  }}
                      ...
                      <div>
                        ...
                        <div class="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                          <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600">
                              <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">
                                <span>Nahraj testy (.zip)</span>
                                <input id="file-upload" name="file-upload"
                                  onInput$={(ev: any) => {
                                    state.tests = ev.target.files[0]
                                  }}
                                  type="file" class="sr-only" />
                              </label>
                              <p class="pl-1">alebo presuň</p>
              ...
              <div class="overflow-hidden shadow sm:rounded-md">
                <div class="bg-white px-4 py-5 sm:p-6">
                  <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="flex sm:pt-5">
                      <label for="pipeline" class="block text-sm font-medium text-gray-700 pr-4 sm:mt-px sm:pt-2">Pipeline</label>
                    ...
                    <div class="flex sm:pt-5">
                      <label for="template" class="block text-sm font-medium text-gray-700 pr-4 sm:mt-px sm:pt-2">Template</label>
                      <div class="mt-1 sm:mt-0">
                ...
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                  <button
                    ...
                    class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Ďalej</button>
                </div>
              </div>
            </div>
          </div>
