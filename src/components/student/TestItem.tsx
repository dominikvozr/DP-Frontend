      ...
      <div class="min-w-0 space-y-3">
        <div class="flex items-center space-x-3">
          ...
          <h2 class="text-sm font-medium">
            <a href={`/professor/test/${props.test._id}`}>
        ...
        <a href={props.test.projectRepo} class="group relative flex items-center space-x-2.5">
          <svg
          ...
          <span class="truncate text-sm font-medium text-gray-500 group-hover:text-gray-900">
            {props.test.exam.subject}/{props.test.exam.name}
          </span>
        </a>
      </div>
      <div class="sm:hidden">
